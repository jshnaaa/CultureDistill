...
def get_llm_for_sequence_regression(
    ...
    **kwargs,
    ...
    if model_type == "reward":
        ...
        cls_class = _get_process_reward_model(base_pretrained_class, base_class, value_head_prefix, packing_samples)
    else:
...
def _get_process_reward_model(base_pretrained_model, base_llm_model, value_head_prefix="score", packing_samples=False):
    class ProcessRewardModel(base_pretrained_model):
        ...
        def __init__(self, config: AutoConfig):
            ...
            setattr(self, value_head_prefix, nn.Linear(config.hidden_size, 2, bias=True))
            # debug: check whether bias is false
        ...
        def forward(
            ...
            values = getattr(self, self.value_head_prefix)(self.dropout(last_hidden_states))
