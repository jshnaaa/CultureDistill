...
def train(args):
    ...
    # Placeholder models for compatibility (not used in GRPO)
    ...
    # Move placeholder models to CPU to save GPU memory
    last_actor.to('cpu')
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Use KL as loss instead of reward penalty (GRPO). When True, KL is added to actor loss, not subtracted from reward."
    )
