...
class HFA_C2N_MAS:
    """
    Home-Field Authority-Activated Cross-Cultural Negotiation MAS.
    ...
    def __init__(self, model_name, tensor_parallel_size=1, config_path=None,
        ...
        Args:
            ...
            config_path: path to hfa_c2n_config.yaml
        ...
        if config_path is None:
            config_path = os.path.join(
                os.path.dirname(__file__), "configs", "hfa_c2n_config.yaml"
            )
    ...
    def detect_guardian(self, target_country: str) -> int:
        ...
        Returns:
            Agent index (0-4) of the Guardian. Returns -1 if no match found
