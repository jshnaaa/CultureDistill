"""
CAMA-D 数据划分脚本：将 HF-CAC 推理数据按 8:1:1 划分为训练集/验证集/测试集
...
def main():
    parser = argparse.ArgumentParser(
        description="CAMA-D: Split HF-CAC data into train/val/test (8:1:1)"
    )
    parser.add_argument("--input", type=str, required=True,
                        help="Input JSONL file (HF-CAC inference data)")
